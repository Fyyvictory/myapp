...
public class GroupSearchMessageActivity extends com.hyphenate.chatuidemo.ui.BaseActivity implements OnClickListener{
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                if(messageaAdapter == null){
                    messageaAdapter = new SearchedMessageAdapter(com.hyphenate.chatuidemo.ui.GroupSearchMessageActivity.this, 1, messageList);
