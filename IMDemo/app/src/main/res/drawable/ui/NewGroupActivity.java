			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
					    ...
					    String reason = com.hyphenate.chatuidemo.ui.NewGroupActivity.this.getString(R.string.invite_join_group);
						...
						runOnUiThread(new Runnable() {
							public void run() {
								progressDialog.dismiss();
								Toast.makeText(com.hyphenate.chatuidemo.ui.NewGroupActivity.this, st2 + e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
							}
						});
					}
