...
public class CallActivity extends com.hyphenate.chatuidemo.ui.BaseActivity {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {                            
                            ...
                            Toast.makeText(com.hyphenate.chatuidemo.ui.CallActivity.this, st2, Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
