...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
        ...
        titleBar.setLeftLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (EasyUtils.isSingleActivity(getActivity())) {
                    Intent intent = new Intent(getActivity(), com.hyphenate.chatuidemo.ui.MainActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_CONTEXT_MENU) {
            switch (resultCode) {
            case com.hyphenate.chatuidemo.ui.ContextMenuActivity.RESULT_CODE_COPY: // copy
                clipboard.setPrimaryClip(ClipData.newPlainText(null, 
                        ((EMTextMessageBody) contextMenuMessage.getBody()).getMessage()));
                break;
            case com.hyphenate.chatuidemo.ui.ContextMenuActivity.RESULT_CODE_DELETE: // delete
                conversation.removeMessage(contextMenuMessage.getMsgId());
                messageList.refresh();
                break;

            case com.hyphenate.chatuidemo.ui.ContextMenuActivity.RESULT_CODE_FORWARD: // forward
    ...
    public void onEnterToChatDetails() {
        if (chatType == Constant.CHATTYPE_GROUP) {
        	...
        	startActivityForResult(new Intent(getActivity(), com.hyphenate.chatuidemo.ui.ChatRoomDetailsActivity.class).putExtra("roomId", toChatUsername), REQUEST_CODE_GROUP_DETAIL);
        }
    }
    ...
    public void onMessageBubbleLongClick(EMMessage message) {
        ...
        startActivityForResult((new Intent(getActivity(), com.hyphenate.chatuidemo.ui.ContextMenuActivity.class)).putExtra("message",message)
