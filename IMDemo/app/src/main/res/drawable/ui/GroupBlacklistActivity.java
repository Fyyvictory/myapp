...
public class GroupBlacklistActivity extends com.hyphenate.chatuidemo.ui.BaseActivity {
			...
			public void run() {
				try {
					...
					if(blockedList != null){
						...
						adapter = new BlacklistAdapter(com.hyphenate.chatuidemo.ui.GroupBlacklistActivity.this, 1, blockedList);
