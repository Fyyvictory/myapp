...
public class GroupDetailsActivity extends com.hyphenate.chatuidemo.ui.BaseActivity implements OnClickListener {
	...
	public static com.hyphenate.chatuidemo.ui.GroupDetailsActivity instance;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			if (progressDialog == null) {
				progressDialog = new ProgressDialog(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this);
	...
	public void exitGroup(View view) {
		startActivityForResult(new Intent(this, com.hyphenate.chatuidemo.ui.ExitGroupDialog.class), REQUEST_CODE_EXIT);
	...
	public void exitDeleteGroup(View view) {
		startActivityForResult(new Intent(this, com.hyphenate.chatuidemo.ui.ExitGroupDialog.class).putExtra("deleteToast", getString(R.string.dissolution_group_hint)),
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							setResult(RESULT_OK);
							finish();
							if(com.hyphenate.chatuidemo.ui.ChatActivity.activityInstance != null)
							    com.hyphenate.chatuidemo.ui.ChatActivity.activityInstance.finish();
						}
					});
	...
	public void onClick(View v) {
		...
		case R.id.clear_all_history: // 清空聊天记录
			...
			new EaseAlertDialog(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this, null, st9, null, new AlertDialogUser() {
		...
		case R.id.rl_blacklist: // 黑名单列表
			startActivity(new Intent(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this, com.hyphenate.chatuidemo.ui.GroupBlacklistActivity.class).putExtra("groupId", groupId));
			break;

		case R.id.rl_change_group_name:
			startActivityForResult(new Intent(this, com.hyphenate.chatuidemo.ui.EditActivity.class).putExtra("data", group.getGroupName()), REQUEST_CODE_EDIT_GROUPNAME);
			break;
		case R.id.rl_search:
            startActivity(new Intent(this, com.hyphenate.chatuidemo.ui.GroupSearchMessageActivity.class).putExtra("groupId", groupId));
					...
					button.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							startActivityForResult(
									(new Intent(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this, GroupPickContactsActivity.class).putExtra("groupId", groupId)),
...
//				button.setCompoundDrawables(null, avatar, null, null);
				...
				button.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (isInDeleteMode) {
							...
							if (EMClient.getInstance().getCurrentUser().equals(username)) {
							    new EaseAlertDialog(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this, st12).show();
								return;
							}
					...
					protected void deleteMembersFromGroup(final String username) {
						final ProgressDialog deleteDialog = new ProgressDialog(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this);
				...
				button.setOnLongClickListener(new OnLongClickListener() {
					...
					public boolean onLongClick(View v) {
					    if(EMClient.getInstance().getCurrentUser().equals(username))
					        return true;
						if (group.getOwner().equals(EMClient.getInstance().getCurrentUser())) {
							new EaseAlertDialog(com.hyphenate.chatuidemo.ui.GroupDetailsActivity.this, null, st15, null, new AlertDialogUser() {
