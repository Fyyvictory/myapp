...
public class ChatRoomDetailsActivity extends com.hyphenate.chatuidemo.ui.BaseActivity implements OnClickListener {
	...
	public static com.hyphenate.chatuidemo.ui.ChatRoomDetailsActivity instance;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			if (progressDialog == null) {
				progressDialog = new ProgressDialog(com.hyphenate.chatuidemo.ui.ChatRoomDetailsActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.clear_all_history: // clear conversation history
			...
			new EaseAlertDialog(com.hyphenate.chatuidemo.ui.ChatRoomDetailsActivity.this, null, st9, null, new AlertDialogUser() {
