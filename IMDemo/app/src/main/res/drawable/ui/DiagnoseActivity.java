 ...
 * 
 */
public class DiagnoseActivity extends com.hyphenate.chatuidemo.ui.BaseActivity implements OnClickListener {
		...
		EMClient.getInstance().uploadLog(new EMCallBack() {
			...
			public void onSuccess() {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(com.hyphenate.chatuidemo.ui.DiagnoseActivity.this, st,
			...
			public void onError(int code, String message) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						progressDialog.dismiss();
						Toast.makeText(com.hyphenate.chatuidemo.ui.DiagnoseActivity.this, st3,
								Toast.LENGTH_SHORT).show();
					}
				});
