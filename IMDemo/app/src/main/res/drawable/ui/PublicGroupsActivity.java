...
public class PublicGroupsActivity extends com.hyphenate.chatuidemo.ui.BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(com.hyphenate.chatuidemo.ui.PublicGroupsActivity.this, GroupSimpleDetailActivity.class).
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(isFirstLoading){
                                ...
                                adapter = new GroupsAdapter(com.hyphenate.chatuidemo.ui.PublicGroupsActivity.this, 1, groupsList);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            pb.setVisibility(View.INVISIBLE);
                            footLoadingLayout.setVisibility(View.GONE);
                            Toast.makeText(com.hyphenate.chatuidemo.ui.PublicGroupsActivity.this, "load failed, please check your network or try it later", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
