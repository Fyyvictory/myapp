...
public class VideoCallActivity extends com.hyphenate.chatuidemo.ui.CallActivity implements OnClickListener {
...
//                            recordBtn.setVisibility(View.VISIBLE);
                            callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.NORMAL;
                            startMonitor();
                        }
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (fError == CallError.REJECTED) {
                                callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.BEREFUSED;
                                callStateTextView.setText(s1);
                            } else if (fError == CallError.ERROR_TRANSPORT) {
                                callStateTextView.setText(s2);
                            } else if (fError == CallError.ERROR_UNAVAILABLE) {
                                callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.OFFLINE;
                                callStateTextView.setText(s3);
                            } else if (fError == CallError.ERROR_BUSY) {
                                callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.BUSY;
                                callStateTextView.setText(s4);
                            } else if (fError == CallError.ERROR_NORESPONSE) {
                                callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.NO_RESPONSE;
                                callStateTextView.setText(s5);
                            }else if (fError == CallError.ERROR_LOCAL_SDK_VERSION_OUTDATED || fError == CallError.ERROR_REMOTE_SDK_VERSION_OUTDATED){
                                callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.VERSION_NOT_SAME;
                                callStateTextView.setText(R.string.call_version_inconsistent);
                            } else {
                                if (isRefused) {
                                    callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.REFUSED;
...
//                                        callStateTextView.setText(s6);
                                    ...
                                    if (isInComingCall) {
                                        callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.UNANSWERED;
                                        callStateTextView.setText(s8);
                                    } else {
                                        if (callingState != com.hyphenate.chatuidemo.ui.CallActivity.CallingState.NORMAL) {
                                            callingState = com.hyphenate.chatuidemo.ui.CallActivity.CallingState.CANCELLED;
        ...
        */
        ...
        case R.id.btn_capture_image:
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(com.hyphenate.chatuidemo.ui.VideoCallActivity.this, "saved image to:" + filename, Toast.LENGTH_SHORT).show();
                }
            });
            break;
        default:
