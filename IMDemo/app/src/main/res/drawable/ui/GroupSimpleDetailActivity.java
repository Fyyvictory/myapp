...
public class GroupSimpleDetailActivity extends com.hyphenate.chatuidemo.ui.BaseActivity {
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							Toast.makeText(com.hyphenate.chatuidemo.ui.GroupSimpleDetailActivity.this, st1+e.getMessage(), Toast.LENGTH_LONG).show();
						}
					});
				}
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							if(group.isMembersOnly())
								Toast.makeText(com.hyphenate.chatuidemo.ui.GroupSimpleDetailActivity.this, st3, Toast.LENGTH_SHORT).show();
							else
								Toast.makeText(com.hyphenate.chatuidemo.ui.GroupSimpleDetailActivity.this, st4, Toast.LENGTH_SHORT).show();
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							Toast.makeText(com.hyphenate.chatuidemo.ui.GroupSimpleDetailActivity.this, st5+e.getMessage(), Toast.LENGTH_SHORT).show();
						}
					});
				}
			}
