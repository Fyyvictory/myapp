package com.example.imdemo.utils;
...
public class PreferanceUtils {
    ...
    private static PreferanceUtils mUtils;
    ...
    private PreferanceUtils(Context cxt) {
    ...
    public static synchronized void init(Context cxt){
        if(mUtils == null){
            mUtils = new PreferanceUtils(cxt);
        }
    }
     ...
     * @return
     */
    public synchronized static PreferanceUtils getInstance() {
        if (mUtils == null) {
